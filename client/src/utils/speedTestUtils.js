export const calculateDownloadSpeed = async () => {
  try {
    ...
    const response = await fetch('https://internet-speed-tester-hl07.onrender.com/download');
...
export const calculateUploadSpeed = async () => {
  try {
    ...
    const response = await fetch('https://internet-speed-tester-hl07.onrender.com/upload', {
      method: 'POST',
      body: data,
      headers: {
